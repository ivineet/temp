...
router.get('/', function(req, res) {
  ...
  console.log('route/calenderjs/current_year:'+current_year);  
  ...
  Promise.join(
    ...
    function(calendar, company, user, superviser){
      ...
      console.log('route/calenderjs/Promise.join()');
