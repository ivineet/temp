...
var get_url_to_site_root_for_anonymous_session = function(req) {
  console.log('application lib route login.js get_url_to_site_root_for_anonymous_session');
  return req.get('host').indexOf('app.icm') < 0
    ? '/'
    : config.get('promotion_website_domain');
}

module.exports = function(passport) {
  console.log('loginjs passport');
