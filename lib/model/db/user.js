...
module.exports = function(sequelize, DataTypes) {
  ...
  console.log('model user after instance_methods 1');
  withCompanyAwareness.call(instance_methods, sequelize);
  console.log('model user after instance_methods 2');
...
function get_instance_methods(sequelize) {
  ...
  return {
    ...
    promise_users_I_can_manage : function(){
      var this_user = this;
      console.log('model/db/use/promise_users_I_can_manage: '+this_user);
    ...
    reload_with_session_details : function(){
      var self = this;
      console.log('model/db/user/reload_with_session_details: '+self);
      return Promise.join(
